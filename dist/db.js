...
const internetSpeed = ['15Mbps', '30Mbps', '50Mbps', '70Mbps'], paymentMethod = ['Raast', 'JazzCash', 'Physical', 'N/A'], cardBanner = ['PURCHASED EXTRA', 'ACTIVATED', 'EXPIRED'];
// Data criteria
...
const userData = [
    ...
    [3, 700, 0, 2, false, 1772939589000, 30, 0],
